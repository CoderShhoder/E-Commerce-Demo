...
(12, 'Upendra', 'Gupta', 'upendra@gmail.com', 'upendra', '9448121558', '123456789', 'sdcjns,djc');
...
$$
DELIMITER ;
CREATE TRIGGER `redeem_points` BEFORE INSERT ON `orders_info` FOR EACH ROW SET new.redeem_points = (new.total_amt*0.01);
--
--
...
(12, 'Upendra', 'Gupta', 'upendra@gmail.com', '123456789', '9448121558', '123456789', 'sdcjns,djc');
